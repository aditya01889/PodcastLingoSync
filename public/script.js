class PodcastTranscriber {
    ...
    async loadSupportedLanguages() {
        try {
            ...
            const transcriptionResponse = await fetch('/api/transcription/languages');
            ...
            const translationResponse = await fetch('/api/translation/languages');
            if (translationResponse.ok) {
                this.translationLanguages = await translationResponse.json();
                this.populateLanguageSelect(this.targetLanguageSelect, this.translationLanguages, true);
            }
        } catch (error) {
    ...
    async handleFormSubmit(e) {
        ...
        try {
            ...
            this.updateProgressStep('step2', 'active');
            this.updateProgress(50, 'Transcribing audio...');

            // Start polling for transcription status
            this.startPolling(targetLanguage);
